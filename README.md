...
/* 🎄 ESTILO NAVIDEÑO */
body {
    background: url("https://i.postimg.cc/vZFLR2zh/bg-navidad.jpg") no-repeat center center fixed;
    background-size: cover;
}

/* Fondo semitransparente para que se lean las tarjetas */
...
/* 🔴 Tarjetas con borde rojo navideño */
.card {
